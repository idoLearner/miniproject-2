...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1268501348ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=testcrud&table=users">`testcrud`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=testcrud&table=records">`testcrud`.`records`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=system_db&table=employee_list">`system_db`.`employee_list`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_handon4&table=record">`db_handon4`.`record`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=system_db&table=users">`system_db`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=records&table=record">`records`.`record`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=system_db&table=employee">`system_db`.`employee`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7c4832487477282f3d295b604c483254">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="testcrud" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `testcrud`.`users` ( `id` INT(16) NOT NULL AUTO_INCREMENT ,  `username` VARCHAR(150) NOT NULL ,  `password` VARCHAR(150) NULL ,  `email` VARCHAR(150) NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `users` (`id`, `username`, `password`, `email`) VALUES (NULL, &#039;admin&#039;, &#039;1234&#039;, &#039;admin@user.user&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="testcrud" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="testcrud" targettable="records">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
